...
public class FcmMessageConverter {
    ...
    public MulticastMessage personalKeywordNoticeToMessage(PersonalNotice personalNotice,
        ...
        return MulticastMessage.builder()
                ...
                .putData("content",
                        personalNotice.getNotice().getContent().substring(0, 30) + "...")
                .putData("link", personalNotice.getNotice().getLink())
                .addAllTokens(fcmTokens)
                .build();
    }

    public MulticastMessage personalHomepageNoticeToMessage(PersonalNotice personalNotice,
            List<String> fcmTokens) {
        return MulticastMessage.builder()
